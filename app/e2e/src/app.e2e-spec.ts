...
class Hero {
  ...
  // Activity from string formatted as '<id> <name>'.
  ...
  // Activity from hero list <li> element.
  ...
  // Activity id and name from the given detail element.
...
describe('Tutorial part 6', () => {
  ...
  function getPageElts() {
    ...
    return {
      ...
      appHeroes: element(by.css('app-root app-activites')),
      allHeroes: element.all(by.css('app-root app-activites li')),
      selectedHeroSubview: element(by.css('app-root app-activites > div:last-child')),

      heroDetail: element(by.css('app-root app-activity-detail > div')),
  ...
  describe('Heroes tests', () => {
    ...
    it('can switch to Heroes view', () => {
      ...
      expect(page.allHeroes.count()).toEqual(10, 'number of activites');
    });
    ...
    it(`deletes ${newHeroName} from Heroes list`, async () => {
      ...
      expect(page.appHeroes.isPresent()).toBeTruthy();
      expect(page.allHeroes.count()).toEqual(9, 'number of activites');
      const heroesAfter = await toHeroArray(page.allHeroes);
      // console.log(await Activity.fromLi(page.allHeroes[0]));
    ...
    it(`adds back ${targetHero.name}`, async () => {
      ...
      expect(heroesAfter.length).toEqual(numHeroes + 1, 'number of activites');

      expect(heroesAfter.slice(0, numHeroes)).toEqual(heroesBefore, 'Old activites are still there');
    ...
    it('displays correctly styled buttons', async () => {
      element.all(by.buttonText('x')).then(buttons => {
        for (const button of buttons) {
          ...
          // Styles defined in activites.component.css
